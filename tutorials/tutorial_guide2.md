...
On:
    ...
    2. Trivial example Lava code but scale it up and test Loihi energy consumption, and Lava CPU backend.
    3. Impress upon students that Lava will be good some day.
